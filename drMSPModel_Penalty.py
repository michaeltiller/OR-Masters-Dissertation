...
def drMSPModel_Penalty(lambda_ramp, alpha, max_rt_DR, max_da_DR, scheduled_profiles, rt_fixed_profiles, n_noon_nodes, n_evening_per_node, scenario_probs, full_scenarios, scenario_to_node, rampLimit, n_starts_max, n_starts):
    ...
    def one_start_per_resource_rule(m, l, n):
        return sum(m.u_Fixed[l, i, n] for i in range(n_starts[l])) <= 1  # was: for i in m.I
